...
function emailNice(props) {
    ...
    const _onMessage = (value) => {
      ...
      props.navigation.navigate('MemberInfo', {resultYn:userInfo[0],nicePhone:userInfo[1],niceName:userInfo[2],niceBirthDate:userInfo[3]});
    ...
    return (
        ...
        <View style={styles.container}>
                ...
                <View style={styles.container6}>
                    ...
                    <TouchableOpacity
                            onPress={() => {
                                props.navigation.navigate('MemberInfo', {resultYn:'',nicePhone:'',niceName:'',niceBirthDate:''});
                            }}
                            >
